    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-20 bg-black/20">
      <div className="bg-card border border-border rounded-xl shadow-lg w-full max-w-sm mx-4 p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 flex items-center justify-center rounded hover:bg-muted text-muted-foreground text-lg"
          >
            Ã—
          </button>
        </div>
            ...
            <div key={h.id} className="flex items-center justify-between py-1">
              ...
              <button
                ...
                className={[
                  ...
                  h.active ? 'bg-foreground' : 'bg-border'
                ].join(' ')}
              >
                <div
                  className={[
        ...
        <form onSubmit={handleCreate} className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-3 py-1.5 bg-foreground text-primary-foreground rounded text-sm font-medium hover:opacity-90"
            >
              Add
            </button>
          </div>
